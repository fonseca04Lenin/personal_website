        ...
        <div style={{
          ...
          <div className="desktop-nav" style={{
            ...
            <div style={{ 
              ...
              <a
                href="https://x.com/fonseca04Lenin"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  color: '#fff',
              ...
              <a
                ...
                onClick={() => track('Resume Download', { source: 'header' })}
                style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <a
                  ...
                  download="Elvin_Fonseca_Resume.pdf"
                  onClick={() => {
                    track('Resume Download', { source: 'mobile_menu' })
                    setMobileMenuOpen(false)
                  }}
                  style={{
                    background: 'linear-gradient(45deg, #f857a6, #ff5858)',
      ...
      >
        ...
        {isMobile ? (
          ...
          <div style={{
            ...
            position: 'relative',
            borderRadius: '14px',
            border: '1px solid rgba(212, 192, 154, 0.12)',
            boxShadow: '0 0 80px rgba(212, 192, 154, 0.04)',
          }}>
            {/* Organic cell/organism branching — 4 curved branches from central hub to each card */}
            <svg
              style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 3 }}
              viewBox="0 0 100 100"
              preserveAspectRatio="none"
            >
              {/* 4 main branches curving from center hub out to each card */}
              <path d="M 50 50 C 44 43, 34 31, 25 26" stroke="rgba(212,192,154,0.45)" strokeWidth="1" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 50 50 C 56 43, 66 31, 75 26" stroke="rgba(212,192,154,0.45)" strokeWidth="1" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 50 50 C 44 57, 34 69, 25 74" stroke="rgba(212,192,154,0.45)" strokeWidth="1" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 50 50 C 56 57, 66 69, 75 74" stroke="rgba(212,192,154,0.45)" strokeWidth="1" fill="none" vectorEffect="non-scaling-stroke" />
              {/* Filament offshoots from card nodes — gives organic/alive feel */}
              <path d="M 25 26 C 21 22, 17 19, 14 16" stroke="rgba(212,192,154,0.22)" strokeWidth="0.7" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 25 26 C 20 24, 16 23, 13 23" stroke="rgba(212,192,154,0.15)" strokeWidth="0.5" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 75 26 C 79 22, 83 19, 86 16" stroke="rgba(212,192,154,0.22)" strokeWidth="0.7" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 75 26 C 80 24, 84 23, 87 23" stroke="rgba(212,192,154,0.15)" strokeWidth="0.5" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 25 74 C 21 78, 17 81, 14 84" stroke="rgba(212,192,154,0.22)" strokeWidth="0.7" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 25 74 C 20 76, 16 77, 13 77" stroke="rgba(212,192,154,0.15)" strokeWidth="0.5" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 75 74 C 79 78, 83 81, 86 84" stroke="rgba(212,192,154,0.22)" strokeWidth="0.7" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 75 74 C 80 76, 84 77, 87 77" stroke="rgba(212,192,154,0.15)" strokeWidth="0.5" fill="none" vectorEffect="non-scaling-stroke" />
              {/* Short flagella-like tendrils from center hub */}
              <path d="M 50 50 C 53 45, 57 41, 60 38" stroke="rgba(212,192,154,0.2)" strokeWidth="0.6" fill="none" vectorEffect="non-scaling-stroke" />
              <path d="M 50 50 C 47 55, 43 59, 40 62" stroke="rgba(212,192,154,0.2)" strokeWidth="0.6" fill="none" vectorEffect="non-scaling-stroke" />
              {/* Card endpoint dots */}
              <circle cx="25" cy="26" r="0.55" fill="rgba(212,192,154,0.65)" />
              <circle cx="75" cy="26" r="0.55" fill="rgba(212,192,154,0.65)" />
              <circle cx="25" cy="74" r="0.55" fill="rgba(212,192,154,0.65)" />
              <circle cx="75" cy="74" r="0.55" fill="rgba(212,192,154,0.65)" />
              {/* Center hub — diamond shape to avoid circle distortion */}
              <polygon points="50,47.8 51.4,50 50,52.2 48.6,50" fill="rgba(212,192,154,0.75)" />
              <polygon points="50,46.5 52.2,50 50,53.5 47.8,50" fill="none" stroke="rgba(212,192,154,0.4)" strokeWidth="0.8" vectorEffect="non-scaling-stroke" />
            </svg>
